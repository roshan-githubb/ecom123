...
export default function ComingSoonAddresses() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 flex items-center justify-center p-4">
      ...
      <div className="max-w-md w-full text-center animate-scale-in">
        ...
        <div className="mb-8 flex justify-center">
          <div className="w-24 h-24 bg-gradient-to-br from-orange-400 to-red-500 rounded-full flex items-center justify-center shadow-lg animate-bounce-in">
        ...
        <p className="text-base text-gray-500 mb-8">
          This feature will be available very soon. Save and manage multiple delivery addresses for faster checkout!
        </p>
