...
export default function ComingSoonProfile() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 flex items-center justify-center p-4">
      ...
      <div className="max-w-md w-full text-center animate-scale-in">
        ...
        <div className="mb-8 flex justify-center">
          <div className="w-24 h-24 bg-gradient-to-br from-purple-400 to-pink-500 rounded-full flex items-center justify-center shadow-lg animate-bounce-in">
        ...
        <p className="text-base text-gray-500 mb-8">
          This feature will be available very soon. Update your profile information and preferences here!
        </p>
