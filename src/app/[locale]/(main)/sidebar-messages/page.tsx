...
export default function ComingSoonMessages() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 flex items-center justify-center p-4">
      ...
      <div className="max-w-md w-full text-center animate-scale-in">
        ...
        <div className="mb-8 flex justify-center">
          <div className="w-24 h-24 bg-gradient-to-br from-indigo-400 to-blue-500 rounded-full flex items-center justify-center shadow-lg animate-bounce-in">
        ...
        <p className="text-lg text-gray-600 mb-2">
          Connect with sellers and support
        </p>
        <p className="text-base text-gray-500 mb-8">
          This feature will be available very soon. Chat with sellers and our support team directly from here!
        </p>
