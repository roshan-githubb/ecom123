...
const CheckoutPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pb-8 overflow-x-hidden">
      {/* Mobile Layout */}
      <main className="md:hidden max-w-md mx-auto relative z-0">
        {isEditing ? (
          <UserForm
      ...
      <main className="hidden md:grid md:grid-cols-2 md:gap-8 md:p-6 lg:gap-12 lg:p-8 max-w-6xl mx-auto">
        {/* Left Column - Form */}
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-6">Checkout</h2>
          ...
          <div
            className="bg-white p-4 md:p-5 rounded-lg border border-gray-200 shadow-sm flex items-center gap-3 cursor-pointer hover:shadow-md transition-shadow"
            onClick={() => setChecked(!checked)}
          >
          ...
          <Button variant="primary" onClick={() => alert("Order Placed!")} className="w-full py-3 text-lg">
            Place Order & Pay
          </Button>
        </div>
